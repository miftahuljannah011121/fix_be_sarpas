        ...
        <div class="card-body">
            ...
            <form action="{{ route('barang.update', $barang) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="stok" name="stok" value="{{ old('stok', $barang->stok) }}"
                        min="0" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text">Format: JPG, JPEG, PNG (Maks. 2MB). Biarkan kosong jika tidak ingin mengubah
                        foto.</div>
                </div>
